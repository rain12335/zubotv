...
# 定义fofa链接
fofa_url = 'https://fofa.info/result?qbase64=InVkcHh5IiAmJiBjaXR5PSJTaGFuZ2hhaSI%3D'
...
if unique_ips_ports:
    ...
    if valid_ip:
        ...
        # 定义需要更新的文件列表
        files_to_update = [
            {'url': 'https://raw.githubusercontent.com/rain12335/zubotv/main/shanghai/shanghaizubo.txt', 'filename': 'shanghaizubo.txt'},
            {'url': 'https://raw.githubusercontent.com/rain12335/zubotv/main/shanghai/shanghaizubo.m3u', 'filename': 'shanghaizubo.m3u'}
        ]
