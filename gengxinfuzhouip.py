...
# 定义fofa链接
fofa_url = 'https://fofa.info/result?qbase64=InVkcHh5IiAmJiBwcm92aW5jZT0iRnVqaWFuIg%3D%3D'
...
if unique_ips_ports:
    ...
    if valid_ip:
        ...
        # 定义需要更新的文件列表
        files_to_update = [
            {'url': 'https://raw.githubusercontent.com/rain12335/zubotv/main/fuzhou/fuzhouzubo.txt', 'filename': 'fuzhouzubo.txt'},
            {'url': 'https://raw.githubusercontent.com/rain12335/zubotv/main/fuzhou/fuzhouzubo.m3u', 'filename': 'fuzhouzubo.m3u'}
        ]
