...
# 定义fofa链接
fofa_url = 'https://fofa.info/result?qbase64=InVkcHh5IiAmJiBjaXR5PSJTdWluaW5nIg%3D%3D'
...
# 定义组播地址和端口
urls_udp = "/udp/239.93.10.112:8668"
...
if unique_ips_ports:
    ...
    if valid_ip:
        ...
        # 定义需要更新的文件列表
        files_to_update = [
            {'url': 'https://raw.githubusercontent.com/rain12335/zubotv/main/suining/suiningzubo.txt', 'filename': 'suiningzubo.txt'},
            {'url': 'https://raw.githubusercontent.com/rain12335/zubotv/main/suining/suiningzubo.m3u', 'filename': 'suiningzubo.m3u'}
        ]
