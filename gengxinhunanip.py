...
if unique_ips_ports:
    ...
    if valid_ip:
        ...
        # 定义需要更新的文件列表
        files_to_update = [
            {'url': 'https://raw.githubusercontent.com/rain12335/zubotv/main/hunan/hunanzubo.txt', 'filename': 'hunanzubo.txt'},
            {'url': 'https://raw.githubusercontent.com/rain12335/zubotv/main/hunan/hunanzubo.m3u', 'filename': 'hunanzubo.m3u'}
        ]
